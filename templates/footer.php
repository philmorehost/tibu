    ...
    <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm text-gray-400">
                <li><a href="/p/about-us" class="hover:text-white transition">About Tibu.ng</a></li>
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm text-gray-400">
                <li><a href="/packages" class="hover:text-white transition">Pricing Plans</a></li>
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm text-gray-400">
                <li><a href="/p/contact" class="hover:text-white transition">Contact Us</a></li>
                <li><a href="/p/faq" class="hover:text-white transition">FAQ</a></li>
                <li><a href="/p/safety-tips" class="hover:text-white transition">Safety Tips</a></li>
            </ul>
        </div>
        <div>
